...
/// </summary>
public sealed class HybridServer : IServer
{
    ...
    public HybridServer(IServiceProvider services, IOptions<TestServerOptions> optionsAccessor)
    ...
    /// <param name="optionsAccessor"></param>
    public HybridServer(IServiceProvider services, IFeatureCollection featureCollection, IOptions<TestServerOptions> optionsAccessor)
    {
    ...
    /// </summary>
    /// <param name="services"></param>
    public HybridServer(IServiceProvider services)
    ...
    /// <param name="services"></param>
    /// <param name="featureCollection"></param>
    public HybridServer(IServiceProvider services, IFeatureCollection featureCollection)
    ...
    public HybridServer(IWebHostBuilder builder)
    ...
    /// <param name="builder"></param>
    /// <param name="featureCollection"></param>
    public HybridServer(IWebHostBuilder builder, IFeatureCollection featureCollection)
    {
    ...
    {
        return new HybridClientHandler(PathBase, Application)
        {
    ...
    {
        return new HybridClientHandler(PathBase, Application, additionalContextConfiguration)
        {
            AllowSynchronousIO = AllowSynchronousIO,
            PreserveExecutionContext = PreserveExecutionContext
        };
    ...
    public HybridRequestBuilder CreateRequest(string path)
    {
        return new HybridRequestBuilder(this, path);
    }
