...
internal sealed class HybridHttpContextBuilder : IHttpBodyControlFeature, IHttpResetFeature
{
    ...
    internal HybridHttpContextBuilder(ApplicationWrapper application, bool allowSynchronousIO, bool preserveExecutionContext)
    {
