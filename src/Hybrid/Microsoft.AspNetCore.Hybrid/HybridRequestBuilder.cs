...
/// </summary>
public sealed class HybridRequestBuilder
{
    ...
    public HybridRequestBuilder(HybridServer server, string path)
    {
    ...
    /// </summary>
    public HybridServer TestServer { get; }
    ...
    public HybridRequestBuilder And(Action<HttpRequestMessage> configure)
    {
    ...
    /// <returns>This <see cref="RequestBuilder"/> for chaining.</returns>
    public HybridRequestBuilder AddHeader(string name, string value)
    {
